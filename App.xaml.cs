...
namespace BarTriggerPrint
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            mutex = new Mutex(true, Constants.BarTriggerPrint, out isNewInstance);
            if (!isNewInstance)
            {
                MessageBox.Show("不能同时运行多个程序实例！");
                App.Current.Shutdown();
            }
            else if (DateTime.Now > new DateTime(2019, 7, 31))
            {
            ...
            //}
            else if (DateTime.Now < new DateTime(2019, 5, 16))
            {
